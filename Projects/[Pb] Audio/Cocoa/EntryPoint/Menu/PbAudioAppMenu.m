...
+ (id)sharedInstance
{
    static PbAudioAppMenu *menu = nil;
...
-(void)createMainSubmenu
{
    ...
    NSMenu* appMenu = [PbAudioPopupMenu sharedInstance];//'[NSMenu new];
    ...
    */
    ...
    NSMenuItem* deviceManagerMenuItem = [[NSMenuItem alloc] initWithTitle:@"Control Surfaces"
                                                                      ...
                                                                      keyEquivalent:@"s"];
    [appMenu addItem:deviceManagerMenuItem];
