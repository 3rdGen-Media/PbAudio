...
@implementation ProxyManagerView



-(void)createScrollListView
{
    _scrollListView = [[CMScrollListView alloc] initWithFrame:CGRectMake(0,0,self.frame.size.width, self.frame.size.height) andDOM:CMProxy];
